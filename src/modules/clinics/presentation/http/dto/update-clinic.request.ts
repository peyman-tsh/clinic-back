...
export class UpdateClinicRequest {
  @ApiProperty({ description: 'Name of the clinic', example: 'Sunrise Dental Clinic', required: false })
  @IsOptional()
  @IsString()
  @Length(1, 150)
  name?: string;
  ...
  @ApiProperty({ description: 'Clinic timezone', example: 'America/New_York', required: false })
  @IsOptional()
  @IsString()
  @Length(1, 50)
  timezone?: string;

  @ApiProperty({ description: 'Clinic default currency', example: 'USD', required: false })
  @IsOptional()
  @IsString()
  @Length(3, 3)
  currency?: string;

  @ApiProperty({ description: 'Clinic status', enum: ClinicStatus, required: false })
  @IsOptional()
  @IsEnum(ClinicStatus)
  status?: ClinicStatus;
}
