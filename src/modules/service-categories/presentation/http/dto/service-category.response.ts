...
export class ServiceCategoryResponse {
  ...
  @ApiProperty({ description: 'Category description', example: 'Botox and fillers', nullable: true })
  description!: string | null;

  @ApiProperty({ description: 'Category image URL', example: 'https://cdn.clinic.com/injectables.jpg', nullable: true })
