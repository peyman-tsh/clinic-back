...
class AuthTokensResponse {
  ...
  @ApiProperty({ description: 'Access token expiration timestamp', example: '2025-01-01T13:00:00.000Z' })
  accessTokenExpiresAt!: string;

  @ApiProperty({ description: 'Refresh token expiration timestamp', example: '2025-01-07T12:00:00.000Z' })
...
export class LoginResponse {
  @ApiProperty({ description: 'Authentication tokens', type: AuthTokensResponse })
